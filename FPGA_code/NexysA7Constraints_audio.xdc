# This file is a general .xdc for the Nexys A7-100T top_audio.v
...
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { startRecording }]; #IO_L21P_T3_DQS_14 Sch=sw[15]
